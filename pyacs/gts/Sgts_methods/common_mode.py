...
###################################################################
    ...
    import pyeq.lib.obs_tensor.obs_tensor2sgts
    import numpy as np
    ...
    T_OBS_RAW , np_names_t_obs, np_obs_date_s = pyeq.lib.obs_tensor.sgts2obs_tensor.sgts2tensor( self, rounding='day' , verbose=verbose )
    ...
    filtered_sgts = pyeq.lib.obs_tensor.obs_tensor2sgts.obs_tensor2sgts( T_OBS_RAW , np_names_t_obs, np_obs_date_s , verbose=verbose)
